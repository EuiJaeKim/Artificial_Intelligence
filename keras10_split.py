...
# Train_Count = int((XXX.size)/10 * 6) # 60%
# Validation_Count = int((XXX.size)/10 * 8) # 60% ~ 80%
# x_train = XXX[:Train_Count]
# x_test = XXX[Validation_Count:]
# y_train = YYY[:Train_Count]
# y_test = YYY[Validation_Count:]
# x_validation = XXX[Train_Count:Validation_Count]
# y_validation = YYY[Train_Count:Validation_Count]
